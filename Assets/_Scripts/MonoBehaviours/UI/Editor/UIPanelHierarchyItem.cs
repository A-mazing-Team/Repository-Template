...
public struct UIPanelHierarchyItem
{
    public int InstanceID { get; }
    public bool IsSelected { get; }
    public bool IsHovered { get; }
    public GameObject GameObject { get; }
    public UIPanel UIPanel { get; }
    ...
    public UIPanelHierarchyItem(int instanceID, Rect selectionRect, UIPanel prettyObject)
    {
        InstanceID = instanceID;
        IsSelected = Selection.Contains(instanceID);
        GameObject = prettyObject.gameObject;
        UIPanel = prettyObject;
